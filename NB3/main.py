...
from model import SASRec, MambaRec,SASMambaRec
from utils import *
...
parser.add_argument('--saslen', default=256, type=int)
...
parser.add_argument('--ssm_ratio', default=1, type=int)
