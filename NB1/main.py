...
from model import SASRec,MambaRec
from utils import *
import numpy as np
...
if __name__ == '__main__':
    ...
    if args.inference_only:
        ...
        print('test (NDCG@5: %.4f, HR@5: %.4f, NDCG@10: %.4f, '
    ...
    for epoch in range(epoch_start_idx, args.num_epochs + 1):
        ...
        if epoch % 10 == 0:
            ...
            t_test = evaluate(model, dataset, args)
            t1 = time.time()
            print('test time:', (t1-t0)*1000)
            print('inference_time', np.mean(t_test[-1]))
            t_valid = evaluate_valid(model, dataset, args)
            print(
            ...
            wandb.log({"HR@5": t_test[1], "HR@10": t_test[3], "HR@20": t_test[5], "NDCG@5": t_test[0], "NDCG@10": t_test[2],"NDCG@20": t_test[4], "loss": loss})
