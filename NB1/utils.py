...
def evaluate(model, dataset, args):
    ...
    for u in tqdm(users):
        ...
        if args.eval_neg_sample == 0:
            candidates = list(set([i + 1 for i in range(itemnum)]) - rated - set(item_idx))
    ...
    return NDCG_5 / valid_user, HT_5 / valid_user, NDCG / valid_user, HT / valid_user, NDCG_20 / valid_user, HT_20 / valid_user, inference_time
    #     if rank < 10:
    #         NDCG += 1 / np.log2(rank + 2)
    #         HT += 1
    #     # if valid_user % 100 == 0:
